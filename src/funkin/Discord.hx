...
class DiscordClient
{
	...
	private static function onDisconnected(errorCode:Int, message:cpp.ConstCharStar):Void {
		#if hxdiscord_rpc trace('Discord: Disconnected ($errorCode: ${cast(message, String)})'); #end
	}
	...
	public static function changePresence(?details:String = 'In the Menus', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageText = "Engine Version: " + funkin.menu.MainMenuState.psychEngineVersion;
	...
	public static function updatePresence() {
		#if hxdiscord_rpc Discord.UpdatePresence(cpp.RawConstPointer.addressOf(presence)); #end
	}
	
	public static function resetClientID() {
		#if hxdiscord_rpc clientID = _defaultID; #end
	}
